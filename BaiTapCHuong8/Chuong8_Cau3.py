...
Label(root, text = "Cộng Trừ Nhân Chia", fg ="blue", font=("Times new romand", 16)).grid(row=0, columnspan = 4)
frameButton = Frame(root)
Button(frameButton, text = "Cộng", command= congAction).pack(side = TOP, fil = X)
